...
Repository, Unit of Work, and Service Layer patterns.((("CSVs, doing everything with", id="ix_CSV")))
It's intended to
...
Here's what a CSV-based repository could look like.((("repositories", "CSV-based repository")))
It abstracts away all the
...
And here's((("Unit of Work pattern", "UoW for CSVs")))
what a UoW for CSVs would look like:
